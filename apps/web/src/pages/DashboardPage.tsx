import { ArrowDownCircle, ArrowUpCircle, PiggyBank, Scale, Wallet } from "lucide-react";
        ...
        <div className="card p-5 sm:p-6 dark:border dark:border-slate-800">
          ...
          <div className="mt-4 space-y-4">
            {data.budgetProgress.length === 0 ? (
              <div className="rounded-lg bg-mist px-4 py-6 text-sm text-slate-500 dark:bg-slate-800 dark:text-slate-400">No category budgets are set for this month.</div>
            ) : (
      ...
      <section className="card p-5 sm:p-6 dark:border dark:border-slate-800">
        ...
        <div className="mt-4 space-y-3">
          {data.recentTransactions.length === 0 ? (
            <div className="rounded-lg bg-mist px-4 py-6 text-sm text-slate-500 dark:bg-slate-800 dark:text-slate-400">No transactions found for this month.</div>
          ) : (
